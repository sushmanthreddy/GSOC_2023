...
def main():
    ...
    ap.add_argument('--outdir', '-o', nargs='?', default='results/result_DevoNet', help='Specify output files directory for create segmentation, labeling & classification images')
    ap.add_argument('--model_nsn', '-ms', nargs='?', help='Specify loading file path of Learned Segmentation Model')
    ap.add_argument('--model_ndn', '-md', nargs='?', help='Specify loading file path of Learned Detection Model')
    ...
    print('DevoNet Completed Process!')
